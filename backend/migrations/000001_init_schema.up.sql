...
CREATE TABLE IF NOT EXISTS statutory_audit_logs (
    ...
    action_type VARCHAR(64) NOT NULL, -- MATCH_OVERRIDE, PAYMENT_HOLD, NOTICE_DISPATCHED, 3B_TABLE4_CLAIMED
    entity_type VARCHAR(64) NOT NULL, -- RECON_RECORD, SALES_INVOICE, NOTICE, COMPLIANCE_ALERT
